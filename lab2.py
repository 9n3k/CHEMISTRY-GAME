    ...
    for event in pygame.event.get():
        ...
        if event.type == pygame.QUIT:
            ...
            if exit_button_rect.collidepoint(event.pos):
                ...
                confirm = messagebox.askyesno("GAME ERROR!", "Still not working? Call a friend")
                if confirm:
                    # Optional: Ask for feedback or a reason
                    reason = simpledialog.askstring("Feedback", "Well atleast not everything in the lab is broken")
