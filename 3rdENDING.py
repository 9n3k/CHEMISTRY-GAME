...
questions = [
    ...
    "correct": 1,
    "correct_feedback": ["If you didn't know this one...", "you'd be cooked for igcse"],
    "wrong_feedback": ["Are you that bad?"]
    },
    {
    ...
    "correct": 0,
    "correct_feedback": ["Never thought"],
    "wrong_feedback": ["Why are you still here..."]
    },
    {
    "question": "Q: Which of these acids are safe to eat?",
    "answers": [
        "A) Sulfuric acid",
        "B) Acetic acid",
        "C) Nitric acid",
    ...
    "correct": 1,
    "correct_feedback": ["..."],
    "wrong_feedback": ["Imagine getting it wrong..."]
    },
    {
    "question": "Q: Want more questions?",
    "answers": [
        "A) Yes",
        "B) Yes",
        "C) Yes",
    ...
    "correct": 0,
    "correct_feedback": ["I WOULD TOO...", "BUT...", "THIS WAS SUCH...", "A LONG TIME TO MAKE...", "IT MAY NOT LOOK THAT GOOD...", "BUT WE SURE DID TRY...", "ANYWAY," "YOU MY FRIEND DID WELL...", "GOODBYE"],
    "wrong_feedback": ["I WOULD TOO...", "BUT...", "THIS WAS SUCH...", "A LONG TIME TO MAKE...", "IT MAY NOT LOOK THAT GOOD...", "BUT WE SURE DID TRY...", "ANYWAY," "YOU MY FRIEND DID WELL...", "GOODBYE"]
    },
]
prank_mode = False
prank_timer = 0
